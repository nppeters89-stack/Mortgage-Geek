        ...
        {showDetail && (
          ...
          <div key={i} className="content-card" style={{ marginBottom: 12 }}>
            ...
            <div style={{ marginTop: 40, padding: "28px 24px", borderRadius: 14, background: `linear-gradient(135deg, ${P.navyDark} 0%, ${P.navy} 100%)`, textAlign: "center" }}>
              <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2.5, textTransform: "uppercase", color: P.gold, display: "block", marginBottom: 10, opacity: 0.85 }}>Put It All Together</span>
              <h3 style={{ fontFamily: F.display, fontSize: "clamp(22px, 3vw, 28px)", color: "#fff", marginBottom: 10, lineHeight: 1.2 }}>See your exact <span style={{ color: P.gold }}>cash to close</span> estimate.</h3>
