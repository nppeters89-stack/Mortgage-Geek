...
const css = `
  ...
  .cc-btn { display: inline-flex; align-items: center; justify-content: center; font-family: ${F.sans}; font-size: 17px; font-weight: 700; text-decoration: none; border-radius: 12px; padding: 16px 30px; min-height: 44px; box-sizing: border-box; background: ${HOME.red}; color: ${HOME.white}; transition: background .2s ease, transform .2s ease; }
  .cc-btn:hover { background: ${HOME.redHover}; transform: translateY(-2px); }
  .cc-direct { font-family: ${F.sans}; font-size: 15px; color: ${HOME.textMuted2}; }
    ...
    <section className="cc-section">
      ...
      <div className="cc-wrap">
        ...
        <div className="cc-right">
          <a className="cc-btn" href="tel:+16156560737">Contact Nick</a>
          <span className="cc-direct">Direct: (615) 656-0737</span>
        </div>
      </div>
    </section>
  );
