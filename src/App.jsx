...
const globalCSS = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  @media (max-width: 900px) {
    ...
    .main-content { margin-left: 0 !important; padding-top: calc(56px + env(safe-area-inset-top, 0px)); padding-bottom: env(safe-area-inset-bottom, 0px); transition: transform 0.3s ease, border-radius 0.3s ease; position: relative; z-index: 130; background: #FAF7F2; min-height: 100dvh; }
    /* Promote main-content to compositor layer only while interacting with sidebar,
       so it moves in lockstep with .mobile-bar (which is always composited).
       Kept scoped to avoid re-introducing the Android scroll regression. */
    .main-content.sidebar-dragging,
    .main-content-open { will-change: transform; }
