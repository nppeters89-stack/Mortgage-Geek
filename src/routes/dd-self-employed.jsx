...
export const meta = () => buildMeta({
  ...
  description: "Self-employed mortgage requirements explained: 2-year rule, tax returns, P&L statements, qualifying income calculations. From a real LO with 13+ years.",
