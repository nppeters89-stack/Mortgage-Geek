...
export const meta = () => buildMeta({
  ...
  description: "Adjustable-rate mortgages explained in plain English. How caps work, when ARMs make sense, qualifying rate quirks. From a real LO with 13+ years.",
