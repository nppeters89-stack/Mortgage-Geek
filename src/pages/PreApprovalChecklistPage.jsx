...
// Dedicated page for the Pre-Approval Checklist, extracted from the Learning Hub
// so it has its own URL and metadata. Reuses the tool-page header (co-brand
// lockup home link + contact phone icon + Learning Hub back link) and renders
// the checklist expanded via the `standalone` prop. Metadata lives in the route
// adapter (routes/pre-approval-checklist.jsx).
export function PreApprovalChecklistPage() {
  return (
    <main style={{ fontFamily: F.body, color: P.text, background: P.cream, minHeight: "100dvh", margin: 0 }}>
      ...
      <Page>
        <PreApprovalChecklist standalone />
      </Page>
