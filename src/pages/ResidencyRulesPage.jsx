  ...
  return (
    <main style={{ fontFamily: F.body, color: P.text, background: P.cream, minHeight: "100dvh", margin: 0 }}>
      ...
      <article className="tool-page-content" style={{ padding: "48px 24px 64px", maxWidth: 860, margin: "0 auto" }}>
        ...
        <Para>
          If you're trying to navigate this for a real loan and want to talk through your specific situation, I'm reachable at <a href="tel:+16156560737" aria-label="Call Nick Peters at 615-656-0737" style={FHA_LINK_STYLE}>(615) 656-0737</a> or <a href="mailto:Nick.Peters@rate.com" aria-label="Email Nick Peters at Nick.Peters@rate.com" style={FHA_LINK_STYLE}>Nick.Peters@rate.com</a>. Bring your status documents and a clear picture of your timeline. We'll figure out what's possible.
        </Para>
