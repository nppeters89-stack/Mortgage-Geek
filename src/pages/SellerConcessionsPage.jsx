  ...
  return (
    <main style={{ fontFamily: F.body, color: P.text, background: P.cream, minHeight: "100dvh", margin: 0 }}>
      ...
      <article className="tool-page-content" style={{ padding: "48px 24px 64px", maxWidth: 860, margin: "0 auto" }}>
        ...
        <Para>
          The practical effect of the flat 6%: on low-down-payment deals, FHA is the most concession-friendly program on this page. A conventional buyer with 3.5% down is capped at 3%; the FHA buyer at the same down payment has double the room. For buyers who are tight on cash to close, that difference alone sometimes decides the program.
        </Para>
